...
import { dateFormat, isBeforeAirDate, runtimeFormat } from '../utils/utilities';
        ...
        <SeasonWapper>
          <Season ref={seasonRef} seasoncontents={height}>
            {seasonApi?.episodes.map((season) => (
              <Episode key={season.id} isBeforeAirDate={isBeforeAirDate(season.air_date)}>
                <EpisodeNumber>
                  <span>{season.episode_number}</span>
                  <EpisodeImage season={season} posterPath={seasonApi.poster_path} />
                </EpisodeNumber>
                <EpisodeInfo>
                  <div>
          ...
          {episodeslength && (
            <MoreButton setHeight={setHeight} more={more} setMore={setMore} setPositionRef={setPositionRef} />
          )}
        </SeasonWapper>
      ) : (
        <NoEpisode>
