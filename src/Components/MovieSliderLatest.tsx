...
import { IGetMoivesResult, ILatest } from "../api";
            ...
            {movieApi && (
              <Box
                ...
                bgPhoto={makeImagePath(
                  movieApi.poster_path || movieApi.backdrop_path,
                  "w500"
                )}
                onClick={() => {
                  onBoxClicked(movieApi.id);
                }}
              >
                <Info variants={infoVariants}>
                  <h4>
                    {mediaType === "movie" ? movieApi.title : movieApi.name}
                  </h4>
                </Info>
              </Box>
            )}
...
export default MovieSliderLatest;
