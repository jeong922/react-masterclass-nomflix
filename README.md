...
- 시리즈의 경우 대부분 영화와 다르게 시즌과 에피소드 정보를 추가적으로 보여준다.
- 시즌2 이상 있을 경우 메뉴로 콘텐츠와 관련된 시즌들을 보여주며, 원하는 시즌을 클릭하면 그 시즌의 에피소드들을 보여준다.
...
- 포스터를 클릭하게 되면 선택한 콘텐츠의 상제 페이지로 이동하여 콘텐츠 상세정보를 확인할 수 있다.
<p align="center">
